...
HFTEACHER_V2_SPEC_1000 = ModelSpec(
    ...
    train_wrapper="scripts/wrappers/train_ltx2b_distilled_waymo_frame_temporal_bottleneck_hf_teacher_action_lora_v2.py",
    infer_wrapper="scripts/wrappers/generate_waymo24_distilled_frame_temporal_bottleneck_hf_teacher_action_minterpolate_lora_v2.py",
...
def syntax_check() -> None:
    files = [
        ...
        "scripts/wrappers/train_ltx2b_distilled_waymo_frame_global_mlp_action_lora.py",
        "scripts/wrappers/train_ltx2b_distilled_waymo_frame_temporal_bottleneck_hf_teacher_action_lora_v2.py",
        "scripts/wrappers/generate_waymo24_distilled_frame_global_mlp_action_minterpolate_lora.py",
        "scripts/wrappers/generate_waymo24_distilled_frame_temporal_bottleneck_hf_teacher_action_minterpolate_lora_v2.py",
        "scripts/compute_video_quality_modal.py",
        "scripts/compute_action_fvd_modal.py",
        "scripts/compute_counterfactual_sensitivity_modal.py",
