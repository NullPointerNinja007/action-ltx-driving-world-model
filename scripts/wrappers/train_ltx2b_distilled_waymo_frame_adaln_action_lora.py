"""Frame-aligned AdaLN action LoRA training for distilled LTX-2B."""

import os

os.environ.setdefault("LTX_MODAL_APP", "ltx2b-dist098-waymo24-frameadaln-action-lora-r16-train")
os.environ.setdefault("LTX_CKPT_2B", "ltxv-2b-0.9.8-distilled.safetensors")
os.environ.setdefault("WAYMO24_ACTION_CONDITIONING", "1")
os.environ.setdefault("WAYMO24_ACTION_ENCODER_TYPE", "frame_adaln")
os.environ.setdefault("WAYMO24_LATENT_PREFIX", "latents")
os.environ.setdefault(
    "LTX_CHECKPOINT_VOLUME_NAME",
    "ltx2b-dist098-waymo24-frameadaln-action-lora-r16-ckpts",
)
os.environ.setdefault(
