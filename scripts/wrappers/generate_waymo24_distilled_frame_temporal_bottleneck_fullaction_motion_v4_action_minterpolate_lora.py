"""Generate 24 FPS Waymo futures from V4 full-112 low-frequency motion action LoRA."""

import os

os.environ.setdefault("LTX_MODAL_APP", "ltx2b-dist098-waymo24-full112-lowfreq-motion-v4-action-infer")
...
os.environ.setdefault(
    ...
    "ltx2b-dist098-waymo24-full112-lowfreq-motion-v4-infer",
)
os.environ.setdefault(
    "LTX_LORA_RUN_NAME",
