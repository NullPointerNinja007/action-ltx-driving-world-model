...
METHODS = [
    ...
    Method(
        ...
        train_wrapper="train_ltx2b_distilled_waymo_frame_temporal_pool_action_lora.py",
        infer_wrapper="generate_waymo24_distilled_frame_temporal_pool_action_minterpolate_lora.py",
    ...
    Method(
        ...
        train_wrapper="train_ltx2b_distilled_waymo_frame_transformer_action_lora.py",
        infer_wrapper="generate_waymo24_distilled_frame_transformer_action_minterpolate_lora.py",
    ...
    Method(
        ...
        train_wrapper="train_ltx2b_distilled_waymo_frame_adaln_action_lora.py",
        infer_wrapper="generate_waymo24_distilled_frame_adaln_action_minterpolate_lora.py",
