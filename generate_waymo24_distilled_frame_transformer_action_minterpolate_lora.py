"""Distilled LTX-2B frame-transformer action LoRA inference wrapper."""
...
os.environ.setdefault(
    ...
    "ltx2b-dist098-waymo24-framexf-action-lora-infer",
)
os.environ.setdefault("LTX_RUNS_ROOT", "distilled098_framexf_action_lora_24fps_minterpolate_seed231_runs")
