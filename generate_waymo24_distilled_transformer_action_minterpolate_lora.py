"""Compatibility wrapper for distilled tiny-transformer action-conditioned LTX-2B Waymo LoRA inference."""
...
os.environ.setdefault(
    ...
    "ltx2b-dist098-waymo24-tinyxf-action-lora-infer",
)
os.environ.setdefault("LTX_RUNS_ROOT", "distilled098_tinyxf_action_lora_24fps_minterpolate_seed231_runs")
