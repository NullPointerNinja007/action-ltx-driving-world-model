"""Temporal bottleneck frame-action conditioning with HF teacher preservation.

This Phase 2 wrapper starts from the corrected shifted-lognormal no-action
visual LoRA and freezes that visual LoRA. Only the frame-action temporal
encoder, temporal residual projectors, and scalar gates are trainable.
"""

import os

os.environ.setdefault("LTX_MODAL_APP", "ltx2b-dist098-waymo24-framebottleneck-hfteacher-action-train")
